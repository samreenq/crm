    ...
    <div class="card m-b-20">
        <div class="card-body">
            ...
            <div class="dt-buttons btn-group">
                <a href="{{route('admin.activities.add')}}"><button type="button" class="btn btn-primary" id="update-ingredent">Add Activity</button></a>
              </div>
            <div class="row" id="manage-activities">
