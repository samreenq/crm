<p class="text-primary">Note: You have rejected meeting Request, please set another request before rejecting the current
    one. Thank You!</p>
...
<form id="update-meeting-request-form" class="mt-3">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="date" id="appointment-date" name="date" class="form-control" placeholder="Select Date"
...
<script>
    $("#update-meeting-request-form").on("submit", function(e) {
        ...
        var url = "{{ route('update-meeting-request-form-ajax') }}";
        setTimeout(() => {
            adminUpdateMeetingRequest(edit_user, url);
        }, 500);
